      ...
      graduateRouterList: [
	    ...
	    employerRouterList:[
	    	{label:'首页',to:'/home',name:'首页'},
	   		...
	   		{label:'信息咨询',children:[{label:'简历搜索',to:'/employer/searchResume',name:'简历搜索'},{label:'收到的简历',to:'/employer/getResume',name:'收到的简历'}]},
	   		{label:'招聘管理',children:[{label:'我的招聘',to:'/employer/myRecruitment',name:'我的招聘'}]},
	    ],
	    adminRouterList:[
	    	{label:'首页',to:'/home'},
	    	{label:'用户管理',to:'/admin/user',name:'用户管理'},
	    	{label:'公告管理',to:'/admin/article',name:'公告管理'},
	    	{label:'就业统计',to:'/admin/jobRate',name:'就业统计'},
	    ],
	    options: {
	      label: 'label',
	      children: 'children',
