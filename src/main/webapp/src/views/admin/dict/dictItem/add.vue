        ...
        methods: {
            fetchDictType(){
                ...
                DICT_API.api(DICT_API.URL_QUERY_ALL_DICT,{}).then(data =>{
                    data.datas.forEach(item =>{
                        this.dictTypeList.push({value:item.dictName,key:item.pkDictId});
                    });
                });
            },
            beforeClose(){
            ...
            btnClick(){
                this.$refs['formName'].validate((valid) => {
                    if (valid) {
                        this.dictTypeList.forEach(item =>{
                            if(item.value == this.form.dictType){
                                this.form.fkDictId = item.key;
                            }
                        });
                        let param ={
                        ...
                        DICT_ITEM_API.api(DICT_ITEM_API.URL_DO_SAVE,param).then(data =>{
