                ...
                <div class="dialog-edit__row dialog-edit__row--long">
                    <div class="dialog-edit__row__item">
                        <el-form-item label="公告标题" prop="articleItem">
                            <el-input v-model="form.ARTICLE_ITEM" disabled></el-input>
                        </el-form-item>
                    </div>
                </div>
                <div class="dialog-edit__row">
                    <div class="dialog-edit__row__item">
                        <el-form-item label="公告类型" prop="articleType">
                            <el-input v-model="articleType[form.ARTICLE_TYPE]" disabled></el-input>
                        </el-form-item>
                    </div>
                    <div class="dialog-edit__row__item">
                        <el-form-item label="发布时间" prop="startTime" >
                            <el-date-picker v-model="form.START_TIME" type="date" placeholder="选择日期" disabled></el-date-picker>
                        </el-form-item>
                    </div>
                </div>
                <div class="dialog-edit__row">
